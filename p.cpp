...
GLfloat trans_x_chap1, trans_x_title1,
	...
	pucboy_x = -630, pucboy_y = -50, trans_x_pb1 = -1630, trans_y_pb1 = -50,
	trans_x_chap5, trans_x_title5,
	clgboy_x = 850, trans_x_cb1 = -1000, clgboy_y = 40,trans_x_ec_gb = -180, trans_y_ec_gb = 1040,
...
void introduction() {
	...
	print("The Epilogue of Education",
		1, 1, 1, title_fade, 280, 380, .3, .3, 4);

	print("by Ayishathul misriya & Fathima musfira",
		1, 1, 1, title_fade, 750, 340, .15, .15, 2);
	print("(4PA20CS021 & 4PA20CS028)",
		1, 1, 1, title_fade, 840, 320, .1, .1, 2);
...
void kindergartenTitleScreen() {
	...
	// Story Title
	print("CHAPTER 1",
		1, 1, 1, kg_chap_fade, 300 + trans_x_chap1, 400, .2, .2, 3);
	print("Kindergarten",
		1, 1, 1, kg_title_fade, 300 + trans_x_title1, 350, .3, .3, 3);
}
...
void kindergarten() {
	...
	print("- Apple",
		1, 1, 1, kg_apple_fade, 655, 445, .2, .2, 3);

	print("B",
		1, 1, 1, kg_b_fade, 600, 380, .3, .3, 3);

	print("- Ball",
		1, 1, 1, kg_ball_fade, 655, 385, .2, .2, 3);
...
void primarySchoolTitleScreen() {
	...
	// Story Title
	print("CHAPTER 2",
		1, 1, 1, ps_chap_fade, 300 + trans_x_chap2, 400, .2, .2, 3);
	print("Primary School",
		1, 1, 1, ps_title_fade, 400, 250 + trans_y_title2, .3, .3, 3);
}
...
void highSchoolTitleScreen() {
	...
	// Story Title
	print("CHAPTER 3",
		1, 1, 1, hs_chap_fade, 300 + trans_x_chap3, 400, .2, .2, 3);
	print("High School",
		1, 1, 1, hs_title_fade, 400 - trans_x_title3, 350, .3, .3, 3);
}
...
void HS_drawSchool() {
  ...
  glVertex2f(400, 175);
	...
	print("SCHOOL", 0, 0, 0, 1, 610, 485, .3, .3, 2);
...
void HS_drawTuition() {
	...
	print(" K S TUITION", 0, 0, 0, 1, 58, 342, .15, .15, 2);
...
void PUCTitleScreen() {
	...
	// Story Title
	print("CHAPTER 4",
		1, 1, 1, puc_chap_fade, 300, 500 - trans_x_chap4, .2, .2, 3);
	print("Pre University College",
		1, 1, 1, puc_title_fade, 400 - trans_x_title4, 450 - trans_x_title4, .3, .3, 3);
}
...
void PUC_drawBoard() {
	...
	print("Mangalore",
		1, 1, 1, 1, 650, 630, .12, .12, 2);
}
void drawPucBoy(GLfloat tx, GLfloat ty,
	GLfloat sx, GLfloat sy,
	GLfloat shirt_r, GLfloat shirt_g, GLfloat shirt_b) {
	glPushMatrix();
...
void PUC() {
	...
	// Red Boy
	drawPucBoy(pucboy_x, pucboy_y,
		1.4, 1.4,
		255,0,0);

	// Green Boy
	drawPucBoy(trans_x_pb1, trans_y_pb1,
		-1.4, 1.4,
		255,0,0);
...
void engineeringCollegeTitleScreen() {
	...
	// Story Title
	print("CHAPTER 5",
		1, 1, 1, eng_chap_fade, 300 + trans_x_chap5, 400, .2, .2, 3);
	print("Engineering College",
		1, 1, 1, eng_title_fade, 400 - trans_x_title5, 350, .3, .3, 3);
}
void drawClgBoy(GLfloat tx, GLfloat ty,
	GLfloat sx, GLfloat sy,
	GLfloat shirt_r, GLfloat shirt_g, GLfloat shirt_b) {
	glPushMatrix();
...
void EC_drawBoys() {
	// Red Boy
	drawClgBoy(clgboy_x, clgboy_y,
		.75, .75,
		255, 0, 0);

	// Green Boy
	drawClgBoy(trans_x_cb1, clgboy_y,
		-.75, .75,
		0, 255, 0);
...
void EC_drawBoard() {
	...
	print("P A COLLEGE OF ENGINEERING",
		1, 1, 1, 1,
		565, 715,
		.1, .1,
		2.5);
...
void workplaceTitleScreen() {
	...
	// Story Title
	print("CHAPTER 6",
		1, 1, 1, wp_chap_fade, 300, 500 - trans_x_chap6, .2, .2, 3);
	print("Workplace",
		1, 1, 1, wp_title_fade, 400 - trans_x_title6, 450, .3, .3, 3);
}
...
void WP_drawThoughtBubble() {
	...
	print("Is this what I want to be doing",
		0, 0, 0, wp_tb_text, 480, 480, .075, .075, 1.5);

	print("for the rest of my life?",
		0, 0, 0, wp_tb_text, 505, 460, .075, .075, 1.5);
}
...
void update(int) {
	...
	if (SCENE_ID == 11) {
		...
		if (clgboy_x <= -180 && trans_x_cb1 <= -2050 && !ec_graduation_done) {
			clgboy_y += 1000;
